...
<div style="display: flex; width:98%;margin:auto;justify-content:space-between">
    <div style="width: 14%; background-color:#ccc;text-align:center;">訂單編號</div>
    <div style="width: 14%; background-color:#ccc;text-align:center;">電影名稱</div>
    <div style="width: 14%; background-color:#ccc;text-align:center;">日期</div>
    <div style="width: 14%; background-color:#ccc;text-align:center;">場次時間</div>
    <div style="width: 14%; background-color:#ccc;text-align:center;">訂購數量</div>
    <div style="width: 14%; background-color:#ccc;text-align:center;">訂購位置</div>
    <div style="width: 14%; background-color:#ccc;text-align:center;">操作</div>
</div>
<?php
